...
using MediaPortal.Plugins.PureAudio.Visualization;

namespace MediaPortal.Plugins.PureAudio
{
  public partial class Player : IExternalPlayer, IDisposable
  {
    ...
    private void Initialize()
    {
      ...
      if (!_Initialized)
      {
        ...
        _Settings = new PureAudioSettings();
        LoadSettings();
    ...
    void _Controller_SessionStarted()
    {
      ...
      if (_VisualizationWindow != null)
        _VisualizationWindow.BassStream = _PlaybackBuffer.VizStream;
    }
