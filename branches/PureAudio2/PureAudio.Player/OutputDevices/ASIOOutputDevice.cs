  ...
  public partial class Player
  {
    private partial class OutputDeviceManager
    {
      private partial class OutputDeviceFactory
      {
        ...
        /// </summary>
        private class ASIOOutputDevice : IOutputDevice
        {
          ...
          public void SetInputStream(BassStream stream)
          {
            ...
            int handle = BassMix.BASS_Mixer_StreamCreate(_InputStream.SampleRate, _InputStream.Channels, streamFlags);
            ...
            WorkItem workItem = EnQueueSTAWorkItem(new WorkItem(new SetSampleRateDelegate(_Driver.SetSampleRate), _InputStream.SampleRate));
            ...
            _Fader = new BassStreamFader(_InputStream, _Settings.FadeDuration);
          }
          ...
          private void Initialize()
          {
            ...
            workItem = EnQueueSTAWorkItem(new WorkItem(new CreateBuffersDelegate(_Driver.CreateBuffers), _Settings.ASIOUseMaxBufferSize));
            workItem.WaitHandle.WaitOne();
          ...
          private void CollectDeviceInfo(int deviceNo)
          {
            ...
            if (Log.IsDebugLevel)
            {
              ...
              for (int i = 0; i < _Driver.OutputChannels.Length; i++)
              {
                Log.Debug(String.Format(
                    "ASIO channel info: name = '{0}', sampletype = {1}",
                    _Driver.OutputChannels[i].Name,
                    _Driver.OutputChannels[i].SampleType.ToString()));
              }
            }
          }
          ...
          private int GetMinASIORate()
          {
            ...
            {
              minimumRate = _Settings.ASIOMinRate;
            }
            return minimumRate;
          }
          ...
          private int GetMaxASIORate()
          {
            ...
            {
              maximumRate = _Settings.ASIOMaxRate;
            }
            return maximumRate;
          }
          ...
          private int GetDeviceNo()
          {
            ...
            string deviceName = _Settings.ASIODevice;
            int deviceNo;
          ...
          private void _Driver_BufferUpdate(object sender, EventArgs e)
          {
            ...
            if (samplesRead == 0)
            {
              // Set a flag so we call OutputStreamEnded() only once.
              if (!_OutputStreamEnded)
              {
