namespace MediaPortal.Plugins.PureAudio.Configuration.Sections
{
  partial class About
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.groupBox1.Controls.Add(this.mpLabel11);
      this.groupBox1.Controls.Add(this.lblAuthorName);
      this.groupBox1.Controls.Add(this.mpLabel13);
      this.groupBox1.Controls.Add(this.lblVersion);
      this.groupBox1.Controls.Add(this.mpLabel15);
      ...
      this.groupBox1.Text = "About this plugin";
      // 
      // label1
      // 
